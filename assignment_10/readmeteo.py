...
# --------------------------------------------------------------------------
    ...
    def dynamic(self):
        ...
        # used for climate sensitivity params
        self.var.Precipitation = self.var.Precipitation*self.var.prec_sensFactor
        ...
        # add params for sensitivity
        self.var.Tavg = self.var.Tavg * self.var.Tavg_sensFactor
